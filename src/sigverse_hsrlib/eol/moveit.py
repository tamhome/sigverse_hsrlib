...
def main():
    cls = HSRBMoveIt(1.0)
    grasps = cls.make_grasps("target1", (0.707, 0.0, 0.707, 0.0), quality=lambda x, y, z, roll, pitch, yaw: 1 - abs(pitch), x=[-0.07], pitch=[-0.2, -0.1, 0, 0.1, 0.2])
    cls.pick("target1", grasps)
